...
use app\utils\webService\VersionableInterface;
use Traversable;
use yii\base\Exception;
use app\utils\workers\repositories\WorkerClientProxyXmlSettingsInterface;
use app\utils\workers\repositories\WorkerClientProxySettingsInterface;
use WorkerSynchroniseCallbackTypes;
 ...
 */
abstract class WorkerInterfaceWithProxiesBase extends WorkerInterfaceBase implements WorkerInterface, WorkerWithProxiesInterface {

    const FAULT_CANT_GET_VERSION = 1;
    const FAULT_WRONG_VERSION    = 2;
    /**
     * @var WebClientProxyInterface[]|Traversable
     */
    ...
    private function initClientProxies() {
        ...
        foreach ($clientProxies as $clientProxy) {
            ...
            $config = new WorkerClientProxyXmlSettingsInterface($this->workerSettings->workerData->configuration);
     ...
     */
    protected abstract function initWorkerClientProxies();
