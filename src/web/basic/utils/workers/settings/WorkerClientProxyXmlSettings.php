 ...
 */
class WorkerClientProxyXmlSettingsInterface implements WorkerClientProxySettingsInterface {
    ...
    private function getDefaultClientProxyXmlConfigElement() {
        if ($this->_cachedDefaultClientProxyXmlConfigElement === null) {
            $this->_cachedDefaultClientProxyXmlConfigElement
                = $this->_configXmlElement->xpath("/worker/clientProxies/clientProxy[@default]")[0];
        }
